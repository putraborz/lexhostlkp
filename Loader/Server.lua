-- Server.lua - Private Server & Server Management Module
local ServerModule = {}
...
function ServerModule.Initialize(ServerPage, player)
	...
	PrivateBtn.MouseButton1Click:Connect(function()
		...
		if success then
			...
			PrivateBtn.Text = "❌ Creation Failed"
			wait(2)
			PrivateBtn.Text = "🔒 Create Private Server"
		end
	end)
	...
	JobIdLabel.Position = UDim2.new(0, 5, 0, 30)
	...
	ServerTypeLabel.Position = UDim2.new(0, 5, 0, 80)
	...
	CopyJobBtn.Position = UDim2.new(0, 5, 0, 375)
	...
	CopyPlaceBtn.Position = UDim2.new(0.52, 5, 0, 375)
	...
	RejoinBtn.Position = UDim2.new(0, 5, 0, 435)
