...
LogoButton.MouseEnter:Connect(function()
	...
	LogoStroke.Thickness = isMobile and 2.5 or 3.5
end)
...
for i, v in ipairs(Tabs) do
	...
	B.MouseEnter:Connect(function() 
		...
		s.Thickness = isMobile and 2 or 2.5
		s.Transparency = 0
	end)
...
print("✅ LEX Host v3 loaded successfully! (Mobile Optimized: " .. tostring(isMobile) .. ")")local UserInputService = game:GetService("UserInputService")
local isMobile = UserInputService.TouchEnabled and not UserInputService.KeyboardEnabled
